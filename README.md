...
The UI walks you through the rest: add a source (paste your API token, which is encrypted before saving), configure a destination, create a job, and trigger your first backup.
...
*Built for the engineers who remember that "the cloud" is just someone else's computer, and plan accordingly.*# GitDR — Git Disaster Recovery
